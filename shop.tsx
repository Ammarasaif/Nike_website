...
import Man from "@/app/assets/men.png";
import Card1 from "../components/card1";
import { MdCurrencyRupee } from "react-icons/md";
import Man2 from "@/app/assets/men2.png";
        ...
        <div className="w-full h-auto px-6 py-6">
            ...
            <div className="flex">
                <div className=" h-[200px] w[200px] ">
                    <Image  className="h-[200px] w-[350px]" src={Man} alt="man" />
                    <div>
                ...
                <Card1 imageUrl={Man2} heading="Nike Dri-FIT Challenger" paragraph="Men's 18cm (approx.) 2-" br="in-1 Versatile Shorts" span="2 495"/>
            </div>
            <div className="flex">
                <div>
